...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24">
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
        <div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
          <p className="pointer-events-none flex place-items-center gap-2 p-8 lg:pointer-events-auto lg:p-0">
            Par{' '}
            <span className="font-bold">Dinitech</span>
          </p>
        </div>
      </div>
      ...
      <p className="mt-8 text-lg text-gray-600 dark:text-gray-400 text-center max-w-2xl">
        Application de test Next.js avec TypeScript et TailwindCSS.
        Parfait pour tester le déploiement sur un serveur Ubuntu.
      </p>
      ...
      <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left mt-16">
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">
            En savoir plus sur ce projet test.
          </p>
        </Link>
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">
            Découvrez les fonctionnalités intégrées.
          </p>
        </Link>
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50 text-balance">
            Découvrez les templates instantanés.
          </p>
        </a>
      </div>
    </main>
